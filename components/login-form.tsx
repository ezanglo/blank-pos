...
import { loginSchema, type LoginFormValues } from "@/lib/schemas/app-forms"
...
export function LoginForm({
  ...
  async function onSubmit(values: LoginFormValues) {
    ...
    // Same as signup: avoid Server Action immediately after auth — cookies may not be sent yet.
