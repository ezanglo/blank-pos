    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          // Inset/floating: align with main content — start below the app header (h-16), not under it.
          variant === "floating" || variant === "inset"
            ? "top-16 bottom-0 p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)]"
            : "inset-y-0 h-svh group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=right]:border-l",
          className
        )}
        {...props}
      >
